<!-- Ryan Marlow
     ...
     IT 328
     home.html
     Green River Project Hub home page that displays a projects table that holds
     projects.  It also displays a button to add new projects and buttons to view
     existing projects.
-->
<!DOCTYPE html>
<html >
                    ...
                    <div class="container-fluid">
                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active text-success" id="nav-detail-tab"
                                   data-toggle="tab"
                                   href="#nav-detail" role="tab" aria-controls="nav-detail"
                                   aria-selected="true">Details</a>
                                <a class="nav-item nav-link text-success" id="nav-client-tab"
                                   data-toggle="tab"
                                   href="#nav-client" role="tab" aria-controls="nav-client"
                                   aria-selected="false">Client Info</a>
                                <a class="nav-item nav-link text-success" id="nav-link-tab"
                                   data-toggle="tab"
                                   href="#nav-link" role="tab" aria-controls="nav-link"
                                   aria-selected="false">Links</a>
                                <a class="nav-item nav-link text-success" id="nav-history-tab"
                                   data-toggle="tab"
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-link" role="tabpanel"
                                    ...
                                    <div class="col-10">
                                        ...
                                        <button type="button" id="add-github"
                                                class="btn btn-outline-success btn-sm btn-block">
                                            Add another URL</button>
                                        <br>
